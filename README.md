...
In this project, I have built a **Jobby App** by applying the React JS concepts I have learned so far.<br/>
Jobby App is a web application designed to streamline the job search process. Built using React JS, the app allows users to browse job listings, search for specific roles, and filter opportunities based on various criteria like job type, location, and salary. The app features a clean and intuitive user interface, making it easy for users to find their desired jobs quickly.

Key functionalities include user authentication, job bookmarking, and a detailed job description page. The Jobby App demonstrates the practical application of various React JS concepts such as component-based architecture, state management, routing, and API integration.

**Deployed Link:** [https://jobpackerkp.ccbp.tech/](https://jobpackerkp.ccbp.tech/)<br/>

**Username:** vishnu <br/>
**Password:** vishnu@2003 <br/>
